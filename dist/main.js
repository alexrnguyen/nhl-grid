...
const getLatestImage = (playerImg, playerId) => {
  ...
  axios__WEBPACK_IMPORTED_MODULE_1__["default"]
    ...
    .then(async (data) => {
      ...
      const teams = await (0,_categories__WEBPACK_IMPORTED_MODULE_0__.getTeams)();
      console.log(teamId);
